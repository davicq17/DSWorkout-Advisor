<script>
	...
	const verificar = async () => {
		...
		try {
			const response = await axios.get(`http://127.0.0.1:8000/Login/User/${IngUser}`);
			...
			<div class="card-text">
				<div class="row">
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
						...
						<button class="btn btn-primary text-decoration-none text-white" onclick={verificar}>
							INICIAR
						</button>
						<!--
                              <a class="btn btn-primary" href="/confuser_ad"> INICIAR</a>
                             -->
						<a href="/registro" class=" btn btn-primary text-decoration-none text-white"
							>REGISTRARSE</a
						>
